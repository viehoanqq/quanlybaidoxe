namespace CarParkingManagementSystem
{
	partial class FormDiscount
	{
		...
		private void InitializeComponent()
		{
			...
			// panel1
			// 
			this.panel1.Controls.Add(this.dtgListDiscount);
			...
			// dtgListDiscount
			// 
			this.dtgListDiscount.BackgroundColor = System.Drawing.Color.WhiteSmoke;
			...
			this.dtgListDiscount.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.dtgListDiscount.Dock = System.Windows.Forms.DockStyle.Fill;
			this.dtgListDiscount.Location = new System.Drawing.Point(0, 34);
			this.dtgListDiscount.Margin = new System.Windows.Forms.Padding(0);
			this.dtgListDiscount.Name = "dtgListDiscount";
			this.dtgListDiscount.RowHeadersWidth = 51;
			this.dtgListDiscount.Size = new System.Drawing.Size(737, 499);
			this.dtgListDiscount.TabIndex = 1;
			this.dtgListDiscount.CellContentClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.dtgListDiscount_CellContentClick);
			// 
			// panel2
			// 
